...
2. Se evaluó el impacto e importancia del nuevo módulo en el proyecto.
3. Se negoció la inclusión del módulo aclarando el impacto en el tiempo, dificultad y necesidades actuales.
4. Se negó la inclusión del nuevo módulo en el MVP debido a la importancia de sacar el producto con los requerimientos escenciales y se dejó el módulo para una versión posterior, considerando adecuar el software actual para ser extensible.

## Actualización de Riesgos

La matriz de riesgos no ha sido afectada dada la postergación del requerimiento.
