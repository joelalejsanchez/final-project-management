...
| --- | ----------------------------------------------------------- | ------------ | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1   | Renuncia de integrantes del equipo de desarrollo            | Medio        | Alto    | Realizar documentación continua del trabajo realizado por estos integrantes. Realizar la contratación de los nuevos integrantes previo salida de los anteriores para realizar la capacitación.                           |
